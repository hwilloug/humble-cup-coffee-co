        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              {
                quote:
                  "The perfect blend of ambiance and exceptional coffee. My daily morning ritual starts here.",
              ...
              {
                quote:
                  "As a digital nomad, I've worked from coffee shops worldwide. This is by far the most welcoming space.",
                author: "David Chen",
              ...
              {
                quote:
                  "Their commitment to quality and sustainability shows in every cup. A true gem in our community.",
